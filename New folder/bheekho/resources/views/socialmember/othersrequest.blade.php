...
<div class="row">
 <div class="col-md-11">
  <br>
  <h1 align="center"><strong>Other's Requests List</strong></h1>
  <br>
  ...
  @endif
    ...
    <div class="form-group col-md-12"> 
      <div class="row">
      <div class="col-md-3">  
        <select class="form-control-2" type="concern" name="manual_filter_table" id="manual_filter_table">
  ...
  <table class="table table-bordered table-striped" id="mytable" style="width:100%"  >
   ...
   <tbody>
   @include('socialmember.other_request_paginated_data')
   </tbody>
  </table> 
...
<script>  
        ...
        function fetch_data(page, manual_filter, manual_filter_tablesm)
            {
              $.ajax({
                  url:"{{ url('socialmember/othersrequest/welcome_manualfilter')}}?page="+page+"&manual_filter_table="+manual_filter+"&manual_filter_tablesm="+manual_filter_tablesm,
