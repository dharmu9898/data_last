...
<div class="row mt--6">
 <div class="col-md-11">
  ...
  <form method="POST" action="{{action('SocialMember\SocialMemberController@addnewrequest', auth::user()->id)}}" enctype="multipart/form-data">
   {{csrf_field()}}   
   ...
   <div class="form-group">
    <textarea type="text" rows="8" name="message" class="form-control" placeholder="Describe Your Issues" value="{{old("message")}}" ></textarea>
   </div>
