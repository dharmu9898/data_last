...
<div class="container">
    <div class="row">
 <div class="col-md-12">
              <div class="panel-heading text-center"><strong style="font-size: 25px;">All Requests </strong></div><br>
  ...
  @endif
    ...
    <div class="col-md-8">    
     <div class="input-group input-group-alternative input-group-merge mb-4">
            ...
            <tbody>
            @include('admin.request.paginated_data')
               </tbody>
            </table>
...
<script>  
    ...
    $(document).on('keyup', '#manual_filter_tablesm', function(){
        ...
        function fetch_data(page, manual_filter, manual_filter_tablesm)
            {
              $.ajax({
                  url:"{{ url('admin/request/index/welcome_manualfilter')}}?page="+page+"&manual_filter_table="+manual_filter+"&manual_filter_tablesm="+manual_filter_tablesm,
