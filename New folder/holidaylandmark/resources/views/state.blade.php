...
<h1 style="text-decoration:none;" class="centered"><a style="text-decoration:none;" href="{{ route('shows',[ 'states' => ($gall->c_s_c_cat) ]) }}" >
   <b style="font-size:24px;color:white;">View
    </b></a> </h1>
</div>
<div class="col-md-8">            

<h2 class="ml-2" style="text-transform: capitalize;padding:5px; font-weight: normal;"><a href=" {{ route('shows',[ 'states' => ($gall->c_s_c_cat) ]) }}"  style="color:#d34205; font-size:20px;" >
   <b>
