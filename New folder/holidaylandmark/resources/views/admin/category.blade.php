            ...
            <div class="card">
                ...
                <div class="col-12">
                    ...
                    <div class="text-left upgrade-btn">
                        <a href="{{ route('admin.Tripcategory') }}" style="font-size:16px;padding:4px;width: 150px;"
                            ...
                            <tbody style="color:black; font:blod; background:#ffff">
                                <tr class="text-center">
                                    ...
                                    <td width="25%">
                                        ...
                                        <form action="{{ route('admin.destroycategory', $employee->id) }}" method="get">
                                            <a href="{{ route('admin.showcategory', $employee->id) }}"
                                                class="btn btn-sm btn-warning"><span class="fa fa-eye"></span> Show</a>
                                            <a href="{{ route('admin.editcategory', $employee->id) }}"
