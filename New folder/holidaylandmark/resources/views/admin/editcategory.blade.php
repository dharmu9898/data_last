                        ...
                        <div class="card-body">
                            <div class="col-md-11">
                                ...
                                <div style="margin-top: 20px;" class="content">
                                    <form method="post" action="{{ route('admin.updatecategory',$data->id) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea rows="10" cols="60" class="form-control" id="Describe"
                                                value="{{ old('Describe') }}" name="Describe"
                                                required>{{ $data->Describe}}</textarea>
                                            <script src="{{ asset('ckeditor/ckeditor.js') }}" required var
                                                editor=CKEDITOR.replace( 'Describe' , { language: 'en' ,
                                            ...
                                            $("form").submit(function(e) {
                                                var messageLength = CKEDITOR.instances['Describe'].getData()
                                                    .replace(/<[^>]*>/gi, '').length;
                                                if (!messageLength) {
