...
{{-- messsage pop up open --}}
  ...
  <div  class="welcome">
      ...
      <div class="card">
        ...
        <h2  class="header"> Add International Tour </h2>

        
          <div style="margin-top: 20px;" class="content">
         
          <form method="post" action="{{ route('admin.uploaddestination') }}" enctype="multipart/form-data">
                  @csrf
             ...
             <textarea rows="10" cols="60" class="form-control" id="Desc"     value="{{ old('Desc') }}" name="Desc" required>{{ old('Desc') }}</textarea>   
             <script src="{{ asset('ckeditor/ckeditor.js') }}" required var editor = CKEDITOR.replace( 'Desc', {
    language: 'en',
