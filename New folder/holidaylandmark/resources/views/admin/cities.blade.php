                  ...
                  @endif 
                    ...
                    <div class="col-12">
                       ...
                       <div class="text-left upgrade-btn">
                            <a href="{{ route('admin.city') }}"  style="font-size:16px;padding:4px;width: 150px;" class="btn btn-primary text-white" > Add Famous City</a>&nbsp;&nbsp;
 ...
 <tbody style="color:black; font:blod; background:#ffff">
  ...
  <td><img src="{{ URL::to('/') }}/public/category/{{ $employee->Image }}" class="rounded-circle" width="60" height="50" /></td>
   ...
   <form action="{{ route('admin.destroycity', $employee->id) }}" method="get">
	<a href="{{ route('admin.showcity', $employee->id) }}" class="btn btn-sm btn-warning"><span class="fa fa-eye"></span> Show</a>
	<a href="{{ route('admin.editcity', $employee->id) }}" class="btn btn-sm btn-info"><span class="fa fa-edit"></span> Edit</a>
  @csrf
                    @method('DELETE')
