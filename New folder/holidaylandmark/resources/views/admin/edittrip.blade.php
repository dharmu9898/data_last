    ...
    border-color: none;">
                    <div class="col-md-12 mx-auto">
                        <div class="form-wrapper">
                            ...
                            <form method="post" action="{{ route('admin.updategallery',$data->id) }}" enctype="multipart/form-data">
          @csrf  
            ...
            if( !messageLength ) {
                ...
                e.preventDefault();
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea rows="10" cols="60" class="form-control" id="Iternary"     value="{{ old('Iternary') }}" name="Iternary" required>{{ $data->Iternary }}</textarea>   
