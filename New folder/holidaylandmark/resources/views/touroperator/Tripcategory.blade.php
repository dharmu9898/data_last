  ...
  <div  class="welcome">
      ...
      <div class="card">
        ...
        <h2  class="header"> Add Trip Category </h2>
          ...
          <form method="post" action="{{ route('touroperator.uploadcategory') }}" enctype="multipart/form-data">
                  @csrf
             ...
             <textarea rows="10" cols="60" class="form-control" id="Describe"     value="{{ old('Describe') }}" name="Describe" required>{{ old('Describe') }}</textarea>   
             <script src="{{ asset('ckeditor/ckeditor.js') }}" required var editor = CKEDITOR.replace( 'Describe', {
    language: 'en',
