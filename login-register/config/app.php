...
return [
    ...
    */
    ...
    'HOLIDAY_M_STORE_URL' => env('HOLIDAY_M_STORE_URL', 'not found in .env file'),
    'HOLIDAY_M_GET_URL' => env('HOLIDAY_M_GET_URL', 'not found in .env file'),
    'HOLIDAY_M_EDIT_URL' => env('HOLIDAY_M_EDIT_URL', 'not found in .env file'),
    'HOLIDAY_M_UPDATE_URL' => env('HOLIDAY_M_UPDATE_URL', 'not found in .env file'),
    'HOLIDAY_M_DELETE_URL' => env('HOLIDAY_M_DELETE_URL', 'not found in .env file'),
